...
implements GuiAction {
    ...
    public void performAction(InventoryClickEvent event, ItemStack stack) {
        ...
        for (int i = current; i <= 7; ++i) {
            ...
            ItemStack itemStack = LoreGuiItem.build("\u00a7c" + configSpaceMissions.name, ItemManager.getId(Material.GLASS), CivCraft.civRandom.nextInt(15), "\u00a76" + CivSettings.localize.localizedString("click_to_view"));
